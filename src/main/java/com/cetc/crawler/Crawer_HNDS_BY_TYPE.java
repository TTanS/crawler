...
public class Crawer_HNDS_BY_TYPE
{
    ...
    throws Exception
  {
    ...
    while (pageTag)
    {
      ...
      for (int j = 0; j < goodsDivs.size() - 2; j++)
      {
        ...
        String savePath = "D:/crawler/惠农电商/" + TimeUtils.getTime() + "/按类别分类/";
        String name = goodClassification + "_" + TimeUtils.getTime() + ".xlsx";
        ...
        ExcelUtils.createExcel(savePath, name, dataTitle, Boolean.valueOf(false));
